...
class ClientAvailableHoursPage extends StatefulWidget {
  final Map<String, List<TimeRange>> initialAvailableHours;
  
  const ClientAvailableHoursPage({
    super.key,
    required this.initialAvailableHours,
  });

  @override
  State<ClientAvailableHoursPage> createState() => _ClientAvailableHoursPageState();
}

class _ClientAvailableHoursPageState extends State<ClientAvailableHoursPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          l10n.available_hours_page_title,
          ...
          child: Column(
            ...
            children: [
              ...
              CustomAvailableHoursSelector(
                ...
                onChanged: (value) {
                  setState(() {
                    // Create a deep copy of the map and its contents
