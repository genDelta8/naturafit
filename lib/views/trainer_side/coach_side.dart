...
class CoachSide extends StatefulWidget {
  const CoachSide({super.key});

  @override
  State<CoachSide> createState() => _CoachSideState();
}

class _CoachSideState extends State<CoachSide>
  ...
  final List<IconData> _cardIcons = [
    Icons.person_add_outlined, // Add Client
    Icons.calendar_month_outlined, // Schedule Session
    Icons.fitness_center_outlined, // Create Workout Plan
    Icons.restaurant_menu_outlined, // Create Meal Plan
  ];
                              ...
                              children: [
                                ...
                                */
                                ...
                                _buildAnimatedActionButton(
                                  ...
                                  label: l10n.schedule_session,
                                  onPressed: () => Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => ScheduleSessionPage(initialSessionCategory: l10n.assessment)),
                                  ),
                                  scaleAnimation: _scaleAnimations[0],
                                  slideAnimation: _slideAnimations[0],
                                  margin: 0,
  ...
  Widget _buildNavButton(int index, IconData icon, String label) {
    ...
    // Map the hardcoded labels to localized strings
