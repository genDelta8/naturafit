...
import 'package:naturafit/views/all_shared_settings/faq_page.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          [
                            _buildSettingItem(
                              ...
                              onTap: () {
                                ...
                                final convertedHeight = (userData?['heightUnit'] ?? 'cm') == 'cm' ? (userData?['height'] ?? 170.0) : (userData?['height'] ?? 170.0) / 30.48;
                                final convertedWeight = (userData?['weightUnit'] ?? 'kg') == 'kg' ? (userData?['weight'] ?? 70.0) : (userData?['weight'] ?? 70.0) * 2.20462;
                            ...
                            _buildSettingItem(
                              ...
                              subtitle: l10n.specializations_subtitle,
                              onTap: () {
                                final userData = context.read<UserProvider>().userData;
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => TrainerSpecializationsPage(
                                      initialSpecializations: (userData?['specializations'] as List<dynamic>?)
                            ...
                            _buildSettingItem(
                              ...
                              subtitle: l10n.certifications_subtitle,
                              onTap: () {
                                final userData = context.read<UserProvider>().userData;
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => TrainerCertificationsPage(
                                      initialEducationList: (userData?['educationList'] as List<dynamic>?)
                            ...
                            _buildSettingItem(
                              ...
                              subtitle: l10n.experience_subtitle,
                              onTap: () {
                                final userData = context.read<UserProvider>().userData;
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => TrainerExperiencePage(
                                      initialExperienceList: (userData?['experienceList'] as List<dynamic>?)
                                          ?.map((item) => item as Map<String, dynamic>)
                                          ?.toList() ?? [],
                                      initialYearsOfExperience: (userData?['yearsOfExperience'] as num?)?.toInt() ?? 0,
                                    ),
                                  ),
                                );
                              },
                            ...
                            _buildSettingItem(
                              ...
                              title: l10n.working_hours,
                              subtitle: l10n.working_hours_subtitle,
                              onTap: () {
                                final userData = context.read<UserProvider>().userData;
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => TrainerWorkingHoursPage(
                            ...
                            _buildSettingItem(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const TrainerSensitiveDataPage(),
                                  ),
                                );
                              },
                            ),
                        ...
                        */
                        /*
                        _buildSection(
                          l10n.business_section,
                          [
                            
                            _buildSettingItem(
                              icon: Icons.currency_exchange,
                              title: l10n.pricing_title,
