...
class CustomPreferenceCheckboxCard extends StatelessWidget {
  final String title;
  ...
  const CustomPreferenceCheckboxCard({
    super.key,
    required this.title,
    this.subtitle,
      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: isSelected ? fadeColor : Colors.transparent,
